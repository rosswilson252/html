...
class FormBuilder {
	 ...
	 * @return string
	 */
	public function select($name, $list = array(), $selected = null, $options = array(), $placeholder = null)
	{
		...
		$html = array();
                ...
                if (!is_null($placeholder) && is_null($selected)) $html[] = $this->placeholderOption($placeholder, null, $selected);
	 ...
	 * @return string
	 */
	protected function placeholderOption($display, $value, $selected)
	{
		$selected = $this->getSelectedValue($value, $selected);

		$options = array('value' => e($value), 'selected' => $selected, 'disabled');
